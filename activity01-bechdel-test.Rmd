...
Movies failing the Bechdel test tend to have higher budgets as well as gross both international and domestic. International gross is larger than domestic gross and overall gross is over the budgets. 
...
Movies with little to no women and movies that pass the Bechdel test tends to have lower budgets and gross overall. Movies with women that onlt talk about men and not to each other tend to make the most money and have the largest budgets.: 
...
Movies passing the test tend to have a larger deviation over the movies that don't pass. The mean for passing movies as well as ones that are dubious and men tend to all be rather similar. Also dubious, notalk, and nowomen all have outliers.
